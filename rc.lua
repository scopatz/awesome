...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ 1, 2, 3, 4, 5, 6, 7, 8, 9 }, s, layouts[s])
end
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    -- Prompt
    -- DEFAULT awful.key({ modkey },            "r",     function () mypromptbox[mouse.screen]:run() end),
...
clientkeys = awful.util.table.join(
    ...
    -- DEFAULT awful.key({ modkey, "Shift"   }, "c",      function (c) c:kill()                         end),
